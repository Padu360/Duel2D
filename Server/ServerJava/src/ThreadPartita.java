    ...
    public void run() {
        ...
        do {
            try {
                 ...
                 * } else {
                 * connessione.invia(giocatorePrincipale.nome + ";" + "sconfitta",
                 * nClientPrincipale);
                 * connessione.invia(giocatorePrincipale.nome + ";" + "vittoria",
                 * nClientSecondario);
                 * }
                 * 
                 ...
                 * Messaggio messaggio = new Messaggio(msg);
                 * messaggio.Splitta();
                 * giocatorePrincipale.muovi(Integer.parseInt(messaggio.x),
                 * Integer.parseInt(messaggio.y));
                 * connessione.invia(messaggio.toCsv(), nClientPrincipale);
                 * connessione.invia(messaggio.toCsv(), nClientSecondario);
                 * } else if (msg.contains("salta")) {
                 * connessione.invia(giocatorePrincipale.nome + ";" + "salta",
                 * nClientPrincipale);
                 * connessione.invia(giocatorePrincipale.nome + ";" + "salta",
                 * nClientSecondario);
                 ...
                 * connessione.invia(giocatorePrincipale.nome + ";" + "sparaADestra",
                 * nClientPrincipale);
                 * connessione.invia(giocatorePrincipale.nome + ";" + "sparaADestra",
                 * nClientSecondario);
                 * } else if (msg.contains("sparaASinistra")) {
                 * connessione.invia(giocatorePrincipale.nome + ";" + "sparaASinistra",
                 * nClientPrincipale);
                 * connessione.invia(giocatorePrincipale.nome + ";" + "sparaASinistra",
                 * nClientSecondario);
                 * }
